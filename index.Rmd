...
- [MBON Pole to Pole Marine Biodiversity: from the Sea to the Cloud  - **Report**](https://drive.google.com/file/d/1XOC1hcg8GRwNxDcfNav4p7bKX7QYVVNb/view?usp=sharing)
...
- Abigail Benson ([OBIS-USA](https://www.usgs.gov/core_science_systems/sas/obis-usa); USGS)
...
- Sergio Cerdeira ([CONABIO](https://www.gob.mx/conabio)) - Sistema de Información y Análisis de Ecosistemas Marinos de México ([SIMAR](https://simar.conabio.gob.mx/))**
...
- Fernando Lima ([CIBIO](https://cibio.up.pt/people/details/fslima) - University of Porto) - Technological approaches for understanding environmental variability in rocky shores**
...
The workshop will be limited to 20 participants. Selection of participants will be based on survey results and their ability and willingness to openly contribute and share data through OBIS, sustain a collaborative long-term monitoring program in their study area, share best practices and contribute to achieving the overall goals of the MBON Pole to Pole. Priority will be given to participants of the previous workshop that conducted biodiversity surveys at their study sites as agreed during this workshop and that have submitted data sheets to the MBON Pole to Pole Github repository. Applicants willing to use and share their own data are also eligible if they provide specific information about the type of dataset, study site location, time span of their dataset and methods employed.

## Survey

In order to partcipate, you will need to complete the survey below (be sure to scroll down within frame), or by visiting the survey directly at https://goo.gl/forms/e8luOKT4lOkeunQq1, before the survey deadline of **December 27, 2018** at 11:59pm (EST).
...
The application deadline is **December 27, 2018**, at midnight (EST). Candidates will receive notice of acceptance by **January 17th, 2019**. Selected participants must confirm attendance to the workshop by replying to the acceptance notification email before **February 1st, 2019**.
