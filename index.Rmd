...
leaflet(pts, options = leafletOptions(attributionControl=F)) %>%
  addProviderTiles(provider = providers$Esri.NatGeoWorldMap, options = tileOptions(opacity=0.5)) %>% #  $Esri.NatGeoWorldMap
  #addProviderTiles(provider = providers$Stamen.TonerLite, options = tileOptions(opacity=0.5)) %>%
