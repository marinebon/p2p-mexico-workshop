...
- Emmett Duffy (MarineGEO) - Predation and fouling community development, exotic invasions and biodiversity - an experimental approach.
...
- Pete Raimondi (UCSC – PISCO / MARINe)*
...
```r
source("https://github.com/marinebon/p2p-brazil-workshop/master/scripts/install-R-packages.R")
```
...
```{r}
# TODO: fix table for pdf output: "Too deeply nested" error with bullets inside cells
